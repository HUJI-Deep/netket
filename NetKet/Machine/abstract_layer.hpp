...
public:
    ...
    */
    virtual void
    InitRandomPars(std::default_random_engine &generator, double sigma)=0;
    ...
    */
    virtual void
    LogVal(const TensorType &input_tensor, TensorType &output_tensor)=0;
    ...
    */
    virtual void
    LogVal(const TensorType &layer_input, TensorType &output_tensor,
    ...
    */
    virtual void InitLookup(const TensorType &input_tensor, TensorType &output_tensor, LookupType &lt)=0;
    ...
    */
    virtual void
    DerLog(const TensorType &input_tensor, TensorType &next_layer_gradient,
    ...
    */
    virtual void
    DerLog(const TensorType &input_tensor, TensorType &next_layer_gradient,
           Eigen::Map<VectorType> &plat_offsets_grad)=0;
};
}
